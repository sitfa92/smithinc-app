...
export const canAccessRoute = (role, routeKey) => {
  ...
  if (role === "va") {
    return ["dashboard", "models", "model-pipeline", "submissions", "bookings", "partners", "partner-pipeline", "partner-submissions", "brand-ambassadors", "brand-ambassador-pipeline", "brand-ambassador-submissions", "analytics", "team", "team-docs", "integrations", "contact-team", "voice-reviews"].includes(routeKey);
  }
  if (role === "agent") {
