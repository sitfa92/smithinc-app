...
const OPTIONS = [
  {
    ...
    detail: "You’ll review the development membership details first, then continue into the application with the right next steps for new talent.",
    href: "/model-development?intent=become-model",
    cta: "View program and apply",
    highlights: ["Program overview", "Membership tiers", "Direct link to submission"],
  },
  {
    id: "get-signed",
    title: "Get signed to agency",
    summary: "Looking for representation? Start the signing process here.",
    detail: "Submit your application directly to our scouting team for review.",
    href: "/model-signup?intent=get-signed",
    cta: "Apply for representation",
    highlights: ["Direct to application", "Scouting team review", "Agency representation"],
  },
  {
    id: "build-portfolio",
  ...
  },
  {
    ...
    summary: "Apply to collaborate as a brand ambassador with campaigns and activations.",
    detail: "Use this route to submit your brand ambassador profile for campaign alignment and collaboration review.",
    href: "/brand-ambassador-submit",
    cta: "Submit brand ambassador profile",
    highlights: ["Collaboration profile", "Campaign-fit review", "Partnership follow-up"],
  },
];
