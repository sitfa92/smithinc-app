...
export default function PublicPartnerSubmission() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok || !json.ok) {
        throw new Error(json.error || "Failed to submit partner application");
      }
  ...
  return (
    <div className="lx-auth-screen" style={{ alignItems: "flex-start", paddingTop: 48 }}>
      <div className="lx-auth-panel wide" style={{ padding: "48px 44px", maxWidth: 720 }}>
        ...
        <h1 className="lx-auth-title">Partner Submission</h1>
        <p className="lx-auth-sub">
          Submit your partner application and our business team will review fit, alignment, and next steps.
        </p>
